...
- O cálculo da nota estava fixo em `App`. Qualquer mudança na regra de pontuação poderia exigir a modificação do do código principal do sistema. Lógica movida para a classe `CalcularNota` e interface `ICalcularNota`.
